...
-   ### Design
    -   #### Colour Scheme
        -   The two main colours used are #fafafa for text and #272525 for main backgrounds.
    -   #### Font Style
        -   I want to use Oswald for the main text headings and Karla for the main paragraph and content.
    -   #### Imagery
        -   I will be using a main Hero image on the call out page to catch user attention and I will also be using a few images to show gym users.
...
1. [Google Fonts:](https://fonts.google.com/)
    - Google fonts were used to import the 'Oswald & Karla' font into the style.css file which is used on all pages throughout the project.
...
-   #### First Time Visitor Goals
    ...
    1. As a First Time Visitor, I want to easily understand the main purpose of the site and learn more about the organisation.
        ...
        1. Upon entering the site, users are automatically greeted with a clean and easily readable navigation bar to go to the part of the page of their choice. Underneath there is a Hero Image with Text welcoming them to the website.
        2. The main points are made immediately with the hero image asking visitors to find out if the gym is for them.
        3. The user has multiple options where the can click the navigation bar to find out more or to just continue to scrolls through the site.
...
-   [Stackoverflow](https://stackoverflow.com/questions/37618091/remove-small-gap-between-nav-and-header): Used for allowing nav bar to line up full width of webpage where before it was leaving a gap.
